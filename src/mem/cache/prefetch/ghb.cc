...
GHBPrefetcher::GHBPrefetcher(const StreamPrefetcherParams *p)
: QueuedPrefetcher(p),
...
void
GHBPrefetcher::calculatePrefetch(const PacketPtr &pkt,
...
void
GHBPrefetcher::resetEntry(StreamTableEntry *this_entry)
{
